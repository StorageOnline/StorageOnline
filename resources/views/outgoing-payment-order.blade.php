                ...
                <div class="modal-content" style="min-height: 370px;">
                    ...
                    <div class="modal-body">
                        <div class="row mb-2">
                            <div class="col-md-6">
                                {{ csrf_field() }}
                                <label for="outgoing_payment_order_id" class="col-md-6 control-label">Номер накладной</label>
                                <div class="col-md-6">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <label for="outgoing_payment_order_quantity" class="col-md-6 control-label">Количество товаров</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-6 text-right">
                                <button id="" type="submit" form="" onclick="setOutgoingOrder();" class="btn btn-success">
                                    Сохранить
                                </button> 
                                <button id="" type="submit" form="" onclick="" class="btn btn-danger">
                                    Отменить
                                </button> 
                                <div class="dropup i_block">
                                    <button id="dropdownMenu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-primary dropdown-toggle">
