...
<head>
   ...
   .description {
    ...
    <body>
    <h1>Рахунок на оплату No 3441 від 31 березня 2018 р.</h1>
    ...
    <div id="provider" class="provider">
        ...
        <div class="description">
            <span>
                <span class="bold">ТОВАРИСТВО З ОБМЕЖЕНОЮ ВІДПОВІДАЛЬНІСТЮ "КРОППЕРС ГРУП"</span><br>
                Р/с 26001000032423, Банк КОМЕРЦІЙНИЙ БАНК "ПІВДЕННИЙ", ОДЕСА, МФО 328209
    ...
    <div id="buyer" class="buyer">
        ...
        <div class="description">
            <span>
                <span class="bold">Фізична особа – підприємець Кандауров Олександр Миколайович</span><br>
                Тел.: 093 012 10 00
            </span>
        </div>
    </div>
    ...
    <div id="sum" class="sum bold">
        <div class="right">
        <span class="">Всього:</span> <span>&nbsp;&nbsp;&nbsp;219,73</span>
         </div>   
    </div>

    <div id="pdv" class="pdv bold">
        <div class="right">
        <span class="">У тому числі ПДВ:</span> <span>&nbsp;&nbsp;&nbsp; 36,62</span>
         </div>
    </div>   

   <div id="total" class="total">
        <div class="left">
        <span class="">Всього найменувань:</span><span id="total-product"> 4</span>, <span>на суму</span><span id="total-sum">&nbsp;219,73 </span>грн.
        </div>
    ...
    <div id="person" class="person" style="float: right;">
        <div class="">
        <span class="bottom-line">Виписав(ла):</span> 
         </div>
    </div>  
